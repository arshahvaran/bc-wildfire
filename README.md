...
├── assets/
│   ├── logo.png / logo.svg       square mark, no text: the app panel header and
│   │                             the gallery thumbnail
│   └── logo_earthengine.*        the same mark beside the project name, for the
│                                 header logo field in the publish wizard
├── docs/
